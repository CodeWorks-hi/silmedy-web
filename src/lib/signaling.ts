...
import { ref, onValue, push, set, remove, Unsubscribe } from "firebase/database";
...
export function sendIceCandidate(roomId: string, candidate: RTCIceCandidate, isCaller: boolean) {
